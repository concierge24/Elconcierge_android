 ...
 */
public class CartLoyalityPoints {
    ...
    private List<ProductLoyalityPoints> list=new ArrayList<>();
    ...
    public List<ProductLoyalityPoints> getList() {
        return list;
    }


    public void setList(List<ProductLoyalityPoints> list) {
        this.list = list;
    }
}
