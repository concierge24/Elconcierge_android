...
class FeedbackActivity : BaseActivity<FragmentFeedbackFormBinding, FeedbackViewModel>(), FeedbackNavigator {
    ...
    override fun feedbackSuccess() {
        AppToasty.success(this, getString(R.string.feedback_added_successfully))
        finish()
    }
