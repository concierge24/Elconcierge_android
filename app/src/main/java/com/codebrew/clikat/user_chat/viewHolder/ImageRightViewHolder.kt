...
import com.codebrew.clikat.databinding.ItemChatImageRightBinding
...
import kotlinx.android.synthetic.main.item_chat_image_right.view.btnResend
import kotlinx.android.synthetic.main.item_chat_image_right.view.ivImage
import kotlinx.android.synthetic.main.item_chat_image_right.view.progressBar

class ImageRightViewHolder private constructor(val binding: ItemChatImageRightBinding, val callback: ChatListener) :
        RecyclerView.ViewHolder(binding.root) {

    companion object {
        fun from(parent: ViewGroup, callback: ChatListener): ImageRightViewHolder {
            val layoutInflater = LayoutInflater.from(parent.context)
            val binding = ItemChatImageRightBinding.inflate(layoutInflater, parent, false)
            return ImageRightViewHolder(binding, callback)
        }
    }
