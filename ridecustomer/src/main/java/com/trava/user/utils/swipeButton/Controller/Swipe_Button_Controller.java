...
public class Swipe_Button_Controller extends AppCompatSeekBar {
    ...
    private LeftSwipeButtonView swipe_button_view;
    private RightSwipeButtonView right_swipe_button_view;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (getProgress() > 85) {
                ...
                if (right_swipe_button_view != null)
                    if (right_swipe_button_view.swipe_both_direction) {
                        if (listener_forward_reverse != null) {
                            if (!right_swipe_button_view.swipe_reverse) {
                                right_swipe_button_view.swipe_reverse = true;
                                right_swipe_button_view.setreverse_180();
                                listener_forward_reverse.onSwipe_RejectForward(right_swipe_button_view);
                            } else {
                                right_swipe_button_view.setreverse_0();
                                right_swipe_button_view.swipe_reverse = false;
                                listener_forward_reverse.onSwipe_RejectReverse(right_swipe_button_view);
                            }
                        }
                    } else {
                        if (listener_forward_reverse != null) {
    ...
    public void setOnSwipeCompleteListener_forward_reverse(OnSwipeCompleteListener listener_forward_reverse, LeftSwipeButtonView swipe_button_view) {
        this.listener_forward_reverse = listener_forward_reverse;
        this.swipe_button_view = swipe_button_view;
    }

    public void setOnSwipeCompleteListener_forward_reverse_right(OnSwipeCompleteListener listener_forward_reverse, RightSwipeButtonView swipe_button_view) {
        this.listener_forward_reverse = listener_forward_reverse;
        this.right_swipe_button_view = swipe_button_view;
    }
