...
public class LeftSwipeButtonView extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public LeftSwipeButtonView(Context context) {
        super(context);
        set_default(null, 0);
    }

    public LeftSwipeButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        set_default(attrs, 0);
    }

    public LeftSwipeButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        set_default(attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public LeftSwipeButtonView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    void set_default(AttributeSet attrs, int defStyle) {
        inflate(getContext(), R.layout.sb_accept_swipe_view, this);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            setBackground(ContextCompat.getDrawable(getContext(), R.drawable.swipe_view_accept_bg));
//        } else {
//            setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.swipe_view_accept_bg));
//        }
...
//                getColor(getContext(), R.color.colorPurple));
