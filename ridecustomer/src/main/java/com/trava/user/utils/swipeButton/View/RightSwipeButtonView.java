package com.trava.user.utils.swipeButton.View;
...
import com.trava.user.utils.swipeButton.Controller.Swipe_Button_Controller;

import static com.trava.user.utils.swipeButton.Util.Dimension_Util.spToPx;
import static com.trava.user.utils.swipeButton.Util.Drawable_Color_Util.setDrawableColor;

/**
 * Created by Gratus on 02/10/18.
 */

public class RightSwipeButtonView extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    public RightSwipeButtonView(Context context) {
        super(context);
        set_default(null, 0);
    }

    public RightSwipeButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
        set_default(attrs, 0);
    }

    public RightSwipeButtonView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        set_default(attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public RightSwipeButtonView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    void set_default(AttributeSet attrs, int defStyle) {
        inflate(getContext(), R.layout.sb_reject_swipe_view, this);
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            setBackground(ContextCompat.getDrawable(getContext(), R.drawable.swipe_view_reject_bg));
//        } else {
//            setBackgroundDrawable(ContextCompat.getDrawable(getContext(), R.drawable.swipe_view_reject_bg));
//        }
    ...
    private void getAttributes(TypedArray attributes) {
        ...
        swipeTextColor = attributes.getColor(R.styleable.SwipeButtonView_sb_swipe_text_color, ContextCompat.getColor(getContext(), R.color.ripple_dark));
        ...
        ThumbImageId = attributes.getResourceId(R.styleable.SwipeButtonView_sb_thumb_image, R.drawable.ic_slide_arrow);
...
//                getColor(getContext(), R.color.edit_text_tint));
...
//        }
    ...
    public void setOnSwipeCompleteListener_forward_reverse(OnSwipeCompleteListener listener_forward_reverse) {
        swipe_button_controller.setOnSwipeCompleteListener_forward_reverse_right(listener_forward_reverse, this);
    }
    @Override
