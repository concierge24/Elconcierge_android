...
import com.trava.user.databinding.HeaderLayoutImagesBinding
import com.trava.user.databinding.NewItemImagesLayoutBinding
import com.trava.user.utils.ConfigPOJO
import kotlinx.android.synthetic.main.item_add_images.view.*

class NewAddImageAdapter(private val imageList: ArrayList<String>?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == TYPE_HEADER) {
            var addImageHeaderBinding:HeaderLayoutImagesBinding= DataBindingUtil.inflate(LayoutInflater.from(parent.context),
                    R.layout.header_layout_images, parent, false)
            addImageHeaderBinding.color = ConfigPOJO.Companion
            HeaderHolder(addImageHeaderBinding.root)
        } else {
            var addImagesBinding:NewItemImagesLayoutBinding= DataBindingUtil.inflate(LayoutInflater.from(parent.context),
                    R.layout.new_item_images_layout, parent, false)
